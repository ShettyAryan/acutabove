...
export function EventsHero() {
  return (
    <section className="relative flex min-h-[58vh] items-center justify-center overflow-hidden bg-primary px-edge pb-16 pt-32 text-center md:min-h-[62vh] md:pt-40">
      <motion.div
        aria-hidden="true"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
